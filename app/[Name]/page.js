    ...
    <div className="charaDiv space-y-5">
      ...
      {result.Start ? (
        <>
          ...
          <img src={`${result.Start}`} alt="Start" />
        </>
      ) : null}
      ...
      {result.Attack ? (
        <>
          ...
          <img src={`${result.Attack}`} alt="Attack" />
        </>
      ) : null}
      ...
      {result.HideAttack ? (
        <>
          ...
          <img src={`${result.HideAttack}`} alt="HideAttack" />
        </>
      ) : null}
      ...
      {result.HideReload ? (
        <>
          ...
          <img src={`${result.HideReload}`} alt="HideReload" />
        </>
      ) : null}
      ...
      {result.Reload ? (
        <>
          ...
          <img src={`${result.Reload}`} alt="Reload" />
        </>
      ) : null}
      ...
      {result.ExAttack ? (
        <>
          ...
          <img src={`${result.ExAttack}`} alt="ExAttack" />
        </>
      ) : null}
      ...
      {result.ExReload ? (
        <>
          ...
          <img src={`${result.ExReload}`} alt="ExReload" />
        </>
      ) : null}
      ...
      {result.Cafe2 ? (
        <>
          ...
          <img src={`${result.Cafe2}`} alt="Cafe2" />
        </>
      ) : null}
    </div>
  );
